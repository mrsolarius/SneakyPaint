...
class TestXMLExportVisitor {
    ...
    void testExport() {
        ...
        assert (xml != null);
        assert (xml.equals("<?xml version=\"1.0\" encoding=\"UTF-8\" ?><root><shapes><shape><type>circle</type><x>10</x><y>10</y></shape><shape><type>square</type><x>20</x><y>20</y></shape><shape><type>triangle</type><x>30</x><y>30</y></shape></shapes></root>"));
    }
